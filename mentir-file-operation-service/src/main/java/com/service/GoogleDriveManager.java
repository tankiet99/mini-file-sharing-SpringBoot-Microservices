...
public class GoogleDriveManager {
    private static final Logger LOG = LoggerFactory.getLogger(GoogleDriveManager.class);
    private static final String APPLICATION_NAME = "Mini File Sharing";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException, URISyntaxException {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                ...
                .setDataStoreFactory(new FileDataStoreFactory(new java.io.File("/usr/src/tokens")))
